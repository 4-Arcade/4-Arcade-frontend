...
//       <Link
//         to={path}
//         className={`text-[15px] font-medium ${isActive ? 'text-text-primary' : 'text-text-secondary'} hover:text-text-primary transition-colors`}
//       >
//         {label}
//       </Link>
//     )
...
//         <Link to="/login" className="text-[14px] font-medium text-blue-600 hover:underline">
//           로그인
//         </Link>
//       </div>
//     </nav>
