      ...
      <div className="flex gap-8 px-20 py-8 flex-1">
        ...
        <div className="w-[360px] flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[13px] font-medium text-text-secondary">카테고리</label>
          ...
          <div className="flex flex-col gap-3 mt-2">
            <Button variant="large" className="w-full">저장하기</Button>
            <Button variant="ghost" className="w-full text-error">삭제하기</Button>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-5">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-text-primary">문제 목록 ({questions.length})</h2>
            <button className="flex items-center gap-1.5 bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-[12px] cursor-pointer hover:bg-blue-700">
          ...
          <div className="flex flex-col gap-3">
            {questions.map((q) => (
              <div key={q.id} className="flex items-center gap-3 bg-white rounded-xl border border-border px-4 py-3">
                <span className="text-sm font-bold text-blue-600 w-6">{q.id}</span>
